<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        @if (Auth::user()->role == 'admin')
            <!-- Dashboards -->
            <li class="menu-item {{ $master_menu === 'home' ? 'active open' : '' }}">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ $item_menu === 'home' ? 'active' : '' }}">
            ...
            <!-- Layouts -->
            <li class="menu-item {{ $master_menu === 'user' ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ $item_menu === 'user' ? 'active' : '' }}">
